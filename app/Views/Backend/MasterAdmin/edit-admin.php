                ...
                <div class="panel-body">
                    ...
                    <form action="<?= base_url('admin/update-admin'); ?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?= $data_admin['username_admin']; ?>" readonly="readonly" onkeypress="return goodchars(event, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', this)" name="username" placeholder="Masukkan Username Pengguna" required="required">
                        </div>
                        <div style="clear:both;"></div>
