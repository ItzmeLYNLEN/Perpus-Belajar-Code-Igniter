                ...
                <div class="panel-body">
                    ...
                    <form action="<?= base_url('admin/simpan-admin'); ?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <!-- Menggunakan JS goodchars untuk membatasi inputan -->
                            <input type="text" class="form-control" onkeypress="return goodchars(event, 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', this)" name="username" placeholder="Masukkan Username Pengguna" required="required">
                        </div>
                        <div style="clear:both;"></div>
