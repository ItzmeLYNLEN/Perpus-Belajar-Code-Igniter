            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group col-md-6">
                        <label>ID Anggota</label><br /><?= session()->get('idAgt'); ?>
                    </div>
                    <div style="clear:both;"></div>
                    <div class="form-group col-md-6">
                        <label>Nama Anggota</label><br /><?= $dataAnggota['nama_anggota']; ?>
                    </div>
                    <div style="clear:both;"></div>
                    <br />
                    ...
                    <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $data['nama_rak']; ?></td>
                                <td><img src="<?= base_url('Assets/Cover_buku/'.$data['cover_buku']); ?>" width="80px"></td>
                                <td><a href="<?= base_url('Assets/E-book/'.$data['e_book']); ?>" target="_blank"><?= $data['e_book']; ?></a></td>
                                <td>
